...
function SettingsPage({ onClose }) {
  ...
  const handleExport = () => {
    ...
    const a    = Object.assign(document.createElement('a'), { href: url, download: 'befluent-data.json' })
    a.click()
      ...
      <div className={styles.content}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.row}>
            <div>
              ...
              <div className={styles.rowSub}>Auto-search as you type (600ms delay)</div>
            </div>
            <button
        ...
        <div className={styles.section}>
          ...
          <div className={styles.aboutList}>
            <div className={styles.aboutRow}><span className={styles.aboutLabel}>Version</span><span className={styles.aboutVal}>1.0.0</span></div>
            <div className={styles.aboutRow}><span className={styles.aboutLabel}>Built with</span><span className={styles.aboutVal}>React + Vite ❤️</span></div>
            <div className={styles.aboutRow}><span className={styles.aboutLabel}>Dictionary</span><span className={styles.aboutVal}>Free Dictionary API</span></div>
            <div className={styles.aboutRow}><span className={styles.aboutLabel}>Translation</span><span className={styles.aboutVal}>MyMemory API</span></div>
            <div className={styles.aboutRow}><span className={styles.aboutLabel}>AI hints</span><span className={styles.aboutVal}>Claude by Anthropic</span></div>
          </div>
          <div className={styles.shortcuts}>
            <div className={styles.sectionTitle} style={{ marginBottom: 8 }}>Keyboard Shortcuts</div>
            {[
              ['/', 'Focus search'],
      ...
      {showReset && (
        <div className={styles.modalBackdrop}>
          <div className={styles.modal}>
            ...
            <p className={styles.modalText}>This will permanently delete all your words, XP, achievements, and review cards. This cannot be undone.</p>
            <div className={styles.modalBtns}>
              <button className={styles.modalCancel} onClick={() => setShowReset(false)}>Cancel</button>
              <button className={styles.modalConfirm} onClick={handleReset}>Yes, reset</button>
            </div>
          </div>
        </div>
      )}
